...
services:
  userscript-proxy:
    image: alling/userscript-proxy:1.1.2
...
To make HTTPS work, you need to make your device trust your proxy by installing a certificate generated by mitmproxy.
